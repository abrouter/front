    ...
    <div class="setting__right">
        <div class="setting__content">
            <div class="setting__stat stat">
                ...
                <p>
                    <br/><br/>
                    <a href="https://docs.abrouter.com/docs/managing/trackingabtests/" target="_blank" style="text-decoration: underline;">Learn more about tracking A/B tests in docs</a>
                    <br/>
                    <br/>
                </p>
