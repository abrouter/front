  ...
  <main>
      ...
      <div class="main-block__container">
        <div class="main-block__body">
          ...
          <div class="main-block__text">
            <p>ABRouter is a platform that solves products problems and helps to improve conversions and user experience. We focused on the developer experience, finite user experience, and of course, on your business. In this post, we'll talk about the implementation of <b>feature flags in Laravel</b>.</p>
          </div>
        </div>
      </div>
    </section>
                ...
                <div class="tabs-what__left">
                  ...
                  <a href="" class="tabs-what__button">
                    ...
                    <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M14.8183 13.4998L9.24951 7.93108L10.8403 6.34033L17.9998 13.4998L10.8403 20.6593L9.24951 19.0686L14.8183 13.4998Z" fill="#32AD67"/>
                    </svg>
                  </a>
                </div>
                <div class="tabs-what__right">
                  <div class="tabs-what__img">
                    <img src="img/new/k1.png" alt srcset="img/new/k1.png 1x, img/new/k1@2x.png 2x">
                  </div>
                </div>
              </div>
            </div>
    ...
    <section class="knot_feature">
      <div class="knot_feature__container">
        ...
        <div class="knot_feature_text">I hope you're interested in using feature flags. There are the following <br />reasons to bring it to your Laravel application:</div>
        <div class="knot_feature_items">
          <div class="knot_feature_item">
            ...
            <p>Sometimes it's the only way to deliver the feature in production. If you're waiting for someone, front end, for example, you have to wait. </p>
            <p>While your feature branch is waiting for the deployment, the code could be broken by someone, or someone from your team will change it and throw you into the work with VCS conflicts. Based on my experience, it's better to deploy when your code is fresh. </p>
            <p>Only one thing which you and your team have to test carefully when you release the feature flag is the correct isolation of the new code. With the right level of code isolation, you can sleep well and disable your feature flag anytime and then fix it and enable it again.</p>
          </div>
          <div class="knot_feature_items_right">
            <div class="knot_feature_item">
              <div class="knot_feature_item_name">Change of the highly-important part of the application that always should be controlled. </div>
              <p>When you change part of your application the mistake can be too expensive, so the right decision is to care about it early and make the change under the feature flag. Feature flags do not imply any measurement of payments or conversions for the changed code, so it will work faster and perfectly fits this goal.</p>
            </div>
            <div class="knot_feature_item">
              <div class="knot_feature_item_name">And the last, but not least is code which shell works time-to-time.</div>
              <div class="knot_feature_item_text">
                <p>For example, it can be a captcha, rate liming, or email confirmation on the sign-up step. You can enable something from it when your Laravel application is experiencing some kind of additional load.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="knot_task_item">
          <div class="knot_task_item_label">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M20 22H4C3.73478 22 3.48043 21.8946 3.29289 21.7071C3.10536 21.5196 3 21.2652 3 21V3C3 2.73478 3.10536 2.48043 3.29289 2.29289C3.48043 2.10536 3.73478 2 4 2H20C20.2652 2 20.5196 2.10536 20.7071 2.29289C20.8946 2.48043 21 2.73478 21 3V21C21 21.2652 20.8946 21.5196 20.7071 21.7071C20.5196 21.8946 20.2652 22 20 22ZM19 20V4H5V20H19ZM8 7H16V9H8V7ZM8 11H16V13H8V11ZM8 15H13V17H8V15Z" fill="#32AD67"/>
            </svg>
            Task definition:
          </div>
          <div class="knot_task_item_name">Our task for today is to wrap the two HTML buttons to the feature flag, one enabled and one - disabled.</div>
          <p>So, we can turn on or turn off one of the buttons or both anytime. Just the usual if-statements with some additional preparation to start working on the ABRouter platform and basic wiring the client in your Laravel project codebase.</p>
        </div>
      </div>
    </section>
          ...
          <div class="knot_form_items">
            ...
            <div class="knot_form_items_wrapper">
              <div class="knot_form_item">
                <div class="knot_form_item_label"><span>Step 1:</span> Sign-up by the <a href="#">link</a></div>
              </div>
              <div class="knot_form_item">
                <div class="knot_form_item_label"><span>Step 2:</span> Create your feature flags.</div>
                <div class="knot_form_item_img">
                  <img src="/img/step/01.png" alt srcset="/img/step/01.png 1x, /img/step/01.png 2x">
                </div>
              </div>
              <div class="knot_form_item">
              ...
              <div class="knot_form_item">
                ...
                <p class="small">This library includes ab-tests and feature flags managing on ABRouter.</p>
                <ul>
                  <li>
                    ...
                    <div class="knot_form_item_i">
                      <p>
                        This package provide auto discovery for service provider. If Symfony package auto-discovery is disabled, add service providers manually in your <span class="code">/app/app.php</span> of your repository.
                      </p>
                      <p>There are service providers you must add:</p>
                      <p><span class="code">\Abrouter\<wbr>LaravelClient\<wbr>Providers\<wbr>AbrouterServiceProvider::class</span></p>
                    </div>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <p>There you have to put your ABRouter token from your dashboard which is described in the third point.</p>
                    <div class="knot_form_item_img _not">
                      <img src="/img/step/03.png" alt srcset="/img/step/03.png 1x, /img/step/03.png 2x">
                    </div>
                  </li>
                </ul>
              </div>
              <div class="knot_form_item">
                ...
                <div class="knot_form_item_img _not">
                  <img src="/img/step/04.png" alt srcset="/img/step/04.png 1x, /img/step/04.png 2x">
                </div>
                <div class="knot_form_item_img _not">
                  <img src="/img/step/04.png" alt srcset="/img/step/04.png 1x, /img/step/04.png 2x">
                </div>
              ...
              <div class="knot_form_item">
                ...
                <div class="knot_form_item_img _not" style="max-width: 400px;">
                  <img src="/img/step/07.png" alt srcset="/img/step/07.png 1x, /img/step/07.png 2x">
                </div>
                <p>One of the button is displayed and one is hidden under the if statement with turned of feature flag.</p>
              </div>
            </div>
          </div>
          <div class="knot_form_nav_wrapper">
            <div class="knot_form_nav">
              ...
              <div class="knot_form_nav_items">
                <div class="knot_form_nav_item" onclick="scroll_to($('.knot_form_item').eq(0))">Step 1: Sign-up by the link</div>
                <div class="knot_form_nav_item" onclick="scroll_to($('.knot_form_item').eq(1))">Step 2: Create your feature flags.</div>
                <div class="knot_form_nav_item" onclick="scroll_to($('.knot_form_item').eq(2))">Step 3: Grab the data</div>
                <div class="knot_form_nav_item" onclick="scroll_to($('.knot_form_item').eq(3))">Step 4: Install</div>
                <div class="knot_form_nav_item" onclick="scroll_to($('.knot_form_item').eq(4))">Step 5: Code</div>
                <div class="knot_form_nav_item" onclick="scroll_to($('.knot_form_item').eq(5))">Step 6: There is our result</div>
              </div>
    ...
    <section class="knot_summary">
      <div class="knot_summary__container">
        ...
        <q class="knot_summary_q">
          <p>I have shown you how to <b>implement the feature flag</b> with <b>Laravel</b> framework via ABRouter. Looks like it's quite simple. Please, remember, that huge or uncertain changes, that couldn't be tested with <span class="_blue">a/b test</span> should be implemented via feature flag to prevent unpredictable situations and save your business.</p>
          <p>If you have any questions, feel free to ask me at <a href="mailto:abrouter@proxiedmail.com" class="_blue">abrouter@proxiedmail.com</a></p>
        </q>
